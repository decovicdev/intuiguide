      ...
      <Stack spacing='0'>
        <VStack align='flex-start' spacing='8' p='4'>
          ...
          <Body1 color='gray' maxW='670px'>
            ...
            factor when you’re running late for a business meeting or driving a
            taxi, but for people looking to enjoy the city and live in the
            moment, the drive is part of the fun. Most route planning apps on
            the market don’t accommodate this.
            <br />
            <br />
            We created Intuiguide to provide access to one that does. Instead of
            relying entirely on traffic and ETA, the Intuiguide app uses an
            ...
            GPS or navigation system, this could take hours – you would need to
            research all your waypoints and add them to your itinerary one by
            one. The Intuiguide algorithm automates the process and suggests
            destinations it thinks you will like. This translates to less time
            spent researching local points of interest, and more time enjoying
            your trip.
            <br />
            <br />
